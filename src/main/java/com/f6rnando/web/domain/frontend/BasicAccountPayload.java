...
public class BasicAccountPayload implements Serializable {
    ...
    public BasicAccountPayload(String email, String username, String password, String confirmPassword, String firstName, String lastName, String description, String phoneNumber, String country) {
        this.email = email;
